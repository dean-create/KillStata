...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new KillstataClient()" to fix this error.`)
    }
    return instance
  }
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Killstata server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Killstata system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Killstata instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Killstata.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that Killstata is working with.
   */
...
export class Config extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Killstata configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Killstata configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Killstata sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Killstata session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Killstata session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Killstata instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Killstata system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Killstata system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Killstata system.
   */
...
export class KillstataClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<KillstataClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    KillstataClient.__registry.set(this, args?.key)
  }
