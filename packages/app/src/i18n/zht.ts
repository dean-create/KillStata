...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Killstata 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Killstata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.killstataZen.line1": "Killstata Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.killstataZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.killstataZen.visit.prefix": "造訪 ",
  "provider.connect.killstataZen.visit.link": "",
  "provider.connect.killstataZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Killstata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Killstata 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Killstata 伺服器。",
  ...
  "toast.update.description": "Killstata 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Killstata 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (killstata.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Killstata 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Killstata 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Killstata 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Killstata 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Killstata 的主題。",
