...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Killstata 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Killstata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.killstataZen.line1": "Killstata Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.killstataZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.killstataZen.visit.prefix": "访问 ",
  "provider.connect.killstataZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Killstata 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Killstata 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Killstata 服务器。",
  ...
  "toast.update.description": "Killstata 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Killstata 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (killstata.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Killstata 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Killstata 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 Killstata 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Killstata 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Killstata 的主题。",
