...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at killstata.io",
  ...
  "Killstata auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Killstata auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Killstata uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Killstata from reading sensitive files",
  "Use {highlight}killstata run{/highlight} for non-interactive scripting",
  "Use {highlight}killstata --continue{/highlight} to resume the last session",
  "Use {highlight}killstata run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}killstata serve{/highlight} for headless API access to Killstata",
  "Use {highlight}killstata run --attach{/highlight} to connect to a running server",
  "Run {highlight}killstata upgrade{/highlight} to update to the latest version",
  "Run {highlight}killstata auth list{/highlight} to see all configured providers",
  "Run {highlight}killstata agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}killstata github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}killstata debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with Killstata for curated, tested models",
