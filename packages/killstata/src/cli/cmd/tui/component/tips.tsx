...
const TIPS = [
  ...
  "不论是单向的固定效应、随机效应还是 GMM，我底层支持了大量的高级计量黑客级用法",
  ...
  "你负责给专业领域的意图和需求，我来帮你转译为极度严谨无错的脚本化 Python 代码运行序列",
  "If an error occurs, Killstata will automatically attempt to debug and retry",
  "哪怕代码真的发生红字故障也别恐慌，系统的自我修复反馈机制会自动定位 BUG 并快速挽救！",
  "You can export your analysis history as Markdown using {highlight}Ctrl+X X{/highlight}",
  "全套分析成果打磨完毕后，利用快捷键 {highlight}Ctrl+X X{/highlight} 将此分析流一键导出为极致的 Markdown 论文笔记",
  ...
  "按下 {highlight}Ctrl+X H{/highlight} ，系统就会为你翻开这本厚重但也极简的 Killstata 生存命令图鉴"
]
