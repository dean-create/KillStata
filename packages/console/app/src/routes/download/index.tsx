...
import desktopAppIcon from "../../asset/lander/killstata-desktop-icon.png"
...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>Killstata | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download Killstata for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="Killstata Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download Killstata</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]</span> Killstata Terminal
            </div>
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("curl -fsSL https://killstata.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>killstata.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g killstata-ai")}>
                <code>
                  npm i -g <strong>killstata-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g killstata-ai")}>
                <code>
                  bun add -g <strong>killstata-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/killstata")}>
                <code>
                  brew install <strong>anomalyco/tap/killstata</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S killstata")}>
                <code>
                  paru -S <strong>killstata</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> Killstata Desktop (Beta)
            </div>
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask killstata-desktop")}>
                <code>
                  brew install --cask <strong>killstata-desktop</strong>
                </code>
                <CopyStatus />
              </button>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[3]</span> Killstata Extensions
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://killstata.ai/docs/ide/" data-component="action-button">
                  Install
                </a>
              </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> Killstata Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://killstata.ai/docs/github/" data-component="action-button">
                  Install
                </a>
              </div>
              ...
              <div data-component="download-row">
                ...
                <a href="https://killstata.ai/docs/gitlab/" data-component="action-button">
                  Install
                </a>
              </div>
            </div>
          ...
          <ul>
            <li>
              <Faq question="What is Killstata?">
                Killstata is an open source agent that helps you write and run code with any AI model. It's available as
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use Killstata?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect Killstata to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, Killstata works with all popular
            ...
            <li>
              <Faq question="How much does Killstata cost?">
                Killstata is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While Killstata works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in Killstata. Learn more about{" "}
