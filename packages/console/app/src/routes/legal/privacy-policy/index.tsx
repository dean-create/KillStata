...
export default function PrivacyPolicy() {
  return (
    <main data-page="legal">
      <Title>Killstata | Privacy Policy</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/privacy-policy`} />
      <Meta name="description" content="Killstata privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Killstata, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Killstata is at all times subject to our Terms of Use,{" "}
                <a href="/legal/terms-of-service">https://killstata.ai/legal/terms-of-service</a>, which incorporates
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Killstata website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Killstata.
                </li>
              ...
              <p>
                ...
                you, Killstata or another party; enforcing any agreements with you; responding to claims that any posting
