...
import { IconKillstata } from "./icons/custom"
import styles from "./share.module.css"
import type { MessageV2 } from "killstata/session/message-v2"
import type { Message } from "killstata/session/message"
import type { Session } from "killstata/session/index"
        ...
        <div data-component="header">
          ...
          <div data-component="header-details">
            <ul data-component="header-stats">
              <li title="killstata version" data-slot="item">
                <div data-slot="icon" title="killstata">
                  <IconKillstata width={16} height={16} />
                </div>
