---
title: TUI
description: Using the Killstata terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Killstata provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Killstata starts the TUI for the current directory.
...
When using the Killstata TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Killstata. Allows you to select from available providers and add their API keys.
...
Exit Killstata. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Killstata config file.
