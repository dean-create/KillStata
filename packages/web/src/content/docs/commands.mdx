...
Create `.killstata/commands/test.md`:

```md title=".killstata/commands/test.md"
---
...
You can add custom commands through the Killstata config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Killstata [config](/docs/config):

```json title="killstata.jsonc" {4-12}
{
...
- Global: `~/.config/killstata/commands/`
- Per-project: `.killstata/commands/`

```markdown title="~/.config/killstata/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".killstata/commands/component.md"
---
...
```md title=".killstata/commands/create-file.md"
---
...
```md title=".killstata/commands/analyze-coverage.md"
---
...
```md title=".killstata/commands/review-changes.md"
---
...
```md title=".killstata/commands/review-component.md"
---
...
killstata includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
