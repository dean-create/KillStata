...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/killstata/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/killstata...\n")
...
console.log("Fetching npm all-time downloads for killstata-ai...\n")
const npmDownloads = await fetchNpmDownloads("killstata-ai")
